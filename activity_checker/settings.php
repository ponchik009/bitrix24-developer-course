<?php
define('C_REST_CLIENT_ID','local.68d667aabe12c5.52814387');//Application ID
define('C_REST_CLIENT_SECRET','Lz9Idrc4rc3r4SLO20EuNW5mW9QFvABXhIQGVDq7cyLPmlZUxC');//Application key
// or
